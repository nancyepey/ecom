...
//
$select_8_prod= mysqli_query($conn, $query);
			...
			<div class="container">
				...
				<div class="new-arrivals-content">
					<div class="row">
						...
						while($row = mysqli_fetch_assoc($select_8_prod)) {
								...
								<div class="single-new-arrival-bg">
									...
									<div class="new-arrival-cart">
										<p>
											...
											<a href="#" class="addtocart">add <span>to </span> cart</a>
										</p>
...
const element = document.getElementsByClassName('addtocart');
console.log(element);

//get card list
const cardList = document.getElementById('navcartlist');
